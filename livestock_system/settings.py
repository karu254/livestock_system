"""
Django settings for livestock_system project.
...
SECRET_KEY = 'django-insecure-rd!-oi(q$pfz4i40$fn=o461u57%3-nb3v$av=z!wi-p%o5_yf'
...
ROOT_URLCONF = 'livestock_system.urls'
...
WSGI_APPLICATION = 'livestock_system.wsgi.application'
